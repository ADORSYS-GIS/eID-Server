...
impl AusweisAppClient {
    pub async fn new() -> Result<Self, String> {
            ...
            match Self::try_connect().await {
                ...
                Err(e) => {
                    ...
                    if retries < MAX_RETRIES {
                        warn!(
                            "Failed to connect to AusweisApp2 (attempt {}/{}), retrying in {}ms...",
        ...
        Err(format!(
            "Failed to connect to AusweisApp2 after {} attempts. Last error: {}",
            MAX_RETRIES,
    ...
    > {
        ...
        debug!(
            "Attempting to connect to AusweisApp2 at {}",
            AUSWEISAPP_WS_URL
        );
    ...
    pub async fn send_apdu(&self, apdu: &[u8]) -> Result<Vec<u8>, String> {
        ...
        match response {
            Message::Text(text) => {
                ...
                hex::decode(text).map_err(|e| format!("Failed to decode response: {}", e))
            }
            Message::Close(frame) => {
