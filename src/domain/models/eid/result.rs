        ...
        let response = GetResultResp {
            value: GetResultResponse {
                ...
                ops_allowed: Some(Operations {
                    document_type: AttributeResp::value(AttrResponse::ALLOWED),
                    issuing_state: AttributeResp::value(AttrResponse::ALLOWED),
                    date_of_expiry: AttributeResp::value(AttrResponse::ALLOWED),
                    given_names: AttributeResp::value(AttrResponse::ALLOWED),
                    family_names: AttributeResp::value(AttrResponse::ALLOWED),
                    academic_title: AttributeResp::value(AttrResponse::ALLOWED),
                    date_of_birth: AttributeResp::value(AttrResponse::ALLOWED),
                    place_of_birth: AttributeResp::value(AttrResponse::ALLOWED),
                    nationality: AttributeResp::value(AttrResponse::ALLOWED),
                    place_of_residence: AttributeResp::value(AttrResponse::ALLOWED),
                    restricted_id: AttributeResp::value(AttrResponse::ALLOWED),
                    age_verification: AttributeResp::value(AttrResponse::ALLOWED),
                    place_verification: AttributeResp::value(AttrResponse::ALLOWED),
                    ..Default::default()
                }),
